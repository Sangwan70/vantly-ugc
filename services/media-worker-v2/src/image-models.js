 ...
 *
 * Mirrors the `image` block of V2_MODELS in @vantly-ugc/schema/v2 (the
 * source of truth). Everything that paints an image reads this file, so
 * switching the default is one line here plus one line in the catalog,
 * never a hunt through the pipelines.
 *

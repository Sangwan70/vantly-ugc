...
import { CharacterSheetGpt2ToolInputSchema } from '@vantly-ugc/schema';
...
export function makeCharacterSheetGpt2Activity(cfg: WorkerConfig) {
  return async function characterSheetGpt2(
    ...
    // Budget caps (same shape as portrait) — admins (ADMIN_EMAILS) skip both
    // entirely, same bypass as deductPrimitiveCredits.

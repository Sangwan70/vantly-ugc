...
import { VideoExtension } from '@/lib/content/builder/VideoExtension';
...
// role -- and no tables. VideoExtension additionally lets a <video>
// generated by the Blog admin's "Generate from generated content" AI
// draft (services/api-v2/.../blog-assist.ts) survive Visual-mode editing
// instead of being dropped as an unrecognized tag -- see its own doc
// comment; sanitizeBlogPostHtml is the only sanitizer that keeps it.
    ...
    editorProps: {
      attributes: {
        ...
        class:
          ...
          '[&_img]:my-2 [&_img]:rounded-md [&_video]:my-2 [&_video]:rounded-md',
